...
function App() {
  ...
  return (
    <div className="portfolio">
      ...
      <footer>
        <div className="container">
          <p>&copy; {new Date().getFullYear()} Youstina Kamal. All rights reserved.</p>
    ...
    <section className="home-section">
      <div className="container">
        ...
        <div className="hero-image">
          <img style={{width:300}} src={profileImage} alt="Youstina Kamal - Software Engineer" />
        </div>
      </div>
    </section>
  );
      ...
      <div className="container">
        ...
        <div className="contact-content">
          <div className="contact-info">
            ...
            <p><strong>Address:</strong> 16-lazoughli street, Helwan, Cairo</p>
